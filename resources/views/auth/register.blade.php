                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="date" type="date" class="form-control" name="birth_date" >
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="county" class="col-md-4 col-form-label text-md-end">{{ __('Country') }}</label>
                        ...
                        <div class="row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" class="btn bg-info text-white btn-block">
                                    {{ __('Register') }}
                                </button>
                            </div>
                        </div>
